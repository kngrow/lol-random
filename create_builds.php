...
<div class="build-wrapper">
  ...
  <div class="builds <?= $menber > $half ? 'red_team' : '' ?>">
    ...
    <div class="item-list">
      ...
      <div class="items">
      <div class="item-img" title="<?= $value['name'] ?>" style="height:<?= $value['image']['h'] ?>px; width:<?= $value['image']['w'] ?>px; background: url('//ddragon.leagueoflegends.com/cdn/<?= $rc->version ?>/img/sprite/<?= $value['image']['sprite'] ?>') -<?= $value['image']['x'] ?>px -<?=   $value['image']['y'] ?>px no-repeat;">
      </div>
